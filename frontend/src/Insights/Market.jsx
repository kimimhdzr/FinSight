    ...
    <div className="market-container">
      <div className="market-overall-container">
        <div className="market-main-container">
          ...
          <a href={data[0].url} style={{ textDecoration: 'none' }}>
            <div className="market-main-texts">
              <p className="market-text-small">
                ...
                {formatTimeAgo(data[0].datetime)}
              </p>
              <p className="market-main-text-large">{data[0].headline}</p>
              <p className="market-main-text-medium">{data[0].summary}</p>
            </div>
          </a>
